...
class Empleado(Base):
    ...
    estado = models.BooleanField(default=True)
    contacEmergencia = models.ForeignKey(ContactoEmergencias, on_delete=models.PROTECT,blank=True, null=True)
    infoAcademica = models.ForeignKey(InfoAcademica, on_delete=models.PROTECT,blank=True, null=True)
    capacitaciones = models.ForeignKey(Capacitaciones, on_delete=models.PROTECT,blank=True, null=True)
